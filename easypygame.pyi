...
def get_event(func: Callable[[_base.event.Event], bool]) -> List[_base.event.Event]:...
def check_event(types: int) -> List[_base.event.Event]: ...
def check_basic() -> None: ...

screen: Optional[_base.Surface]
display_screen: Optional[_base.Surface]
