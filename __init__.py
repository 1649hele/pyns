...
import _io
try:
    import structures, fm, func, flat_gui_base, sound, file, screen, network, win, stereoscopic_gui, iter, module
except ImportError:
    from . import structures, fm, func, flat_gui_base, sound, file, screen, network, win, stereoscopic_gui, iter, module
